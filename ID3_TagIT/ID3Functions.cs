...
namespace ID3_TagIT
{
  ...
  internal sealed class ID3Functions
  {
    ...
    {
      if (((((ReplaceFormat & Declarations.FormatReplace.CompareTAGFilename) |
             (ReplaceFormat & Declarations.FormatReplace.OrganizeFiles)) |
             (ReplaceFormat & Declarations.FormatReplace.FilenameToTAG)) > ((Declarations.FormatReplace)0)) && ((((((vstrFormat.IndexOf(":") >= 0) | (vstrFormat.IndexOf('"') >= 0)) | (vstrFormat.IndexOf("/") >= 0)) | (vstrFormat.IndexOf("*") >= 0)) | (vstrFormat.IndexOf("|") >= 0)) | (vstrFormat.IndexOf("?") >= 0)))
    ...
    {
      ArrayList list = new ArrayList { Convert.ToByte(abytBuffer[0]) };
